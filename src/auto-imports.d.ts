...
declare global {
  ...
  const nextOrderKey: typeof import('./composables/use-drag-order').nextOrderKey
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly nextOrderKey: UnwrapRef<typeof import('./composables/use-drag-order')['nextOrderKey']>
